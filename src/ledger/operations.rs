...
pub async fn process_transfers(
    client: &Arc<TbClient>,
    batch: &mut Vec<LedgerTransfer>,
    responders: &mut Vec<oneshot::Sender<TigerBeetleResult<Vec<LedgerCreateTransfersResult>>>>,
) {
...
pub async fn process_accounts(
    client: &Arc<TbClient>,
    batch: &mut Vec<LedgerAccount>,
    responders: &mut Vec<oneshot::Sender<TigerBeetleResult<Vec<LedgerCreateAccountsResult>>>>,
) {
...
pub async fn process_lookup_accounts(
    client: &Arc<TbClient>,
    batch: &mut Vec<u128>,
    responders: &mut Vec<oneshot::Sender<TigerBeetleResult<Vec<LedgerAccount>>>>,
) {
...
pub async fn process_lookup_transfers(
    client: &Arc<TbClient>,
    batch: &mut Vec<u128>,
    responders: &mut Vec<oneshot::Sender<TigerBeetleResult<Vec<LedgerTransfer>>>>,
) {
